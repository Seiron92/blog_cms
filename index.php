...
<div class="mainCon">
 ...
 /* SEND COMMENT TO DATABASE */
                ...
                if (isset($_REQUEST['comsubmit'])) {
                  ...
                  header("Location: http://studenter.miun.se/~rese1800/dt093g/projekt/index.php#leavemsg ");
                  exit;
                }
                ...
                <div id="userList">
                    ...
                    while ($row = $result->fetch_assoc()) {
                      ...
                      echo '<li>' . "<a href='index.php?user=$username'>" . $username . '</a></li>';
                    }
                    echo '</ul>';
                    if (isset($_GET['user'])) {
                      $id2 = $_GET["user"];
                      ...
                      // GET IMAGE //
                      $image = $blogProfile->getSImage($id2);
